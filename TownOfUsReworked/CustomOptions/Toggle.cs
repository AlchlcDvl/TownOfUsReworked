...
{
    public CustomToggleOption(int id, MultiMenu menu, string name, bool value, object parent = null) : base(id, menu, name, CustomOptionType.Toggle, value, parent, null) => Format = (val, _)
        => (bool)val ? "On" : "Off";
