namespace TownOfUsReworked.CustomOptions
{
    ...
    public static class Generate
    {
        ...
        public static void GenerateAll()
        {
            ...
            CPMax = new(num++, MultiMenu.crew, "Max <color=#8CFFFFFF>Crew</color> <color=#1D7CF2FF>Protective</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] { AltruistOn,
                MedicOn });
            ...
            CSvMax = new(num++, MultiMenu.crew, "Max <color=#8CFFFFFF>Crew</color> <color=#1D7CF2FF>Sovereign</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] { MayorOn,
                DictatorOn, MonarchOn });
            ...
            CrewSupportSettings = new(MultiMenu.crew, "<color=#8CFFFFFF>Crew</color> <color=#1D7CF2FF>Support</color> Settings", new[] { ChameleonOn, EngineerOn, EscortOn,
                RetributionistOn, ShifterOn, TransporterOn });
            CSMax = new(num++, MultiMenu.crew, "Max <color=#8CFFFFFF>Crew</color> <color=#1D7CF2FF>Support</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] { ChameleonOn,
                EngineerOn, EscortOn, RetributionistOn, ShifterOn, TransporterOn });
            ...
            //Crewmate = new(MultiMenu.crew, "<color=#8CFFFFFF>Crewmate</color>", CrewmateOn);
            ...
            NeutralSettings = new(MultiMenu.neutral, "<color=#B3B3B3FF>Neutral</color> Settings", new[] { AmnesiacOn, GuardianAngelOn, SurvivorOn, ThiefOn, PlaguebearerOn, ActorOn,
                BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn, ArsonistOn, CryomaniacOn, GlitchOn, JuggernautOn, MurdererOn, SerialKillerOn, WerewolfOn,
                DraculaOn, WhispererOn, JackalOn, NecromancerOn });
            NeutralVision = new(num++, MultiMenu.neutral, "<color=#B3B3B3FF>Neutral</color> Vision", 1.5f, 0.25f, 5f, 0.25f, MultiplierFormat, new[] { AmnesiacOn, GuardianAngelOn,
                SurvivorOn, ThiefOn, PlaguebearerOn, ActorOn, BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn, ArsonistOn, CryomaniacOn, GlitchOn, JuggernautOn,
                MurdererOn, SerialKillerOn, WerewolfOn, DraculaOn, WhispererOn, JackalOn, NecromancerOn });
            ...
            NeutralFlashlight = new(num++, MultiMenu.neutral, "<color=#B3B3B3FF>Neutrals</color> Use A Flashlight", false, new[] { AmnesiacOn, GuardianAngelOn, SurvivorOn, ThiefOn,
                PlaguebearerOn, ActorOn, BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn, ArsonistOn, CryomaniacOn, GlitchOn, JuggernautOn, MurdererOn,
                SerialKillerOn, WerewolfOn, DraculaOn, WhispererOn, JackalOn, NecromancerOn });
            ...
            AvoidNeutralKingmakers = new(num++, MultiMenu.neutral, "Avoid <color=#B3B3B3FF>Neutral</color> Kingmakers", false, new[] { AmnesiacOn, GuardianAngelOn, SurvivorOn, ThiefOn,
                PlaguebearerOn, ActorOn, BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn, ArsonistOn, CryomaniacOn, GlitchOn, JuggernautOn, MurdererOn,
                SerialKillerOn, WerewolfOn, DraculaOn, WhispererOn, JackalOn, NecromancerOn });
            ...
            VigiKillsNB = new(num++, MultiMenu.neutral, "<color=#FFFF00FF>Vigilante</color> Kills <color=#B3B3B3FF>Neutral</color> <color=#1D7CF2FF>Benigns</color>", true, new[] {
                AmnesiacOn, GuardianAngelOn, SurvivorOn, ThiefOn, VigilanteOn });
            ...
            NEMax = new(num++, MultiMenu.neutral, "Max <color=#B3B3B3FF>Neutral</color> <color=#1D7CF2FF>Evil</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] { ActorOn,
                BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn });
            NeutralEvilsEndGame = new(num++, MultiMenu.neutral, "<color=#B3B3B3FF>Neutral</color> <color=#1D7CF2FF>Evils</color> End The Game When Winning", false, new[] { ActorOn,
                BountyHunterOn, CannibalOn, ExecutionerOn, GuesserOn, JesterOn, TrollOn });
            ...
            VigiKillsExecutioner = new(num++, MultiMenu.neutral, "<color=#FFFF00FF>Vigilante</color> Kills <color=#CCCCCCFF>Executioner</color>", false, new[] { ExecutionerOn,
                VigilanteOn }, true);
            ...
            ICMax = new(num++, MultiMenu.intruder, "Max <color=#FF0000FF>Intruder</color> <color=#1D7CF2FF>Concealing</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                BlackmailerOn, CamouflagerOn, GrenadierOn, JanitorOn });
            ...
            IntruderDeceptionSettings = new(MultiMenu.intruder, "<color=#FF0000FF>Intruder</color> <color=#1D7CF2FF>Deception</color> Settings", new[] { DisguiserOn, MorphlingOn,
                WraithOn });
            IDMax = new(num++, MultiMenu.intruder, "Max <color=#FF0000FF>Intruder</color> <color=#1D7CF2FF>Deception</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                DisguiserOn, MorphlingOn, WraithOn });
            ...
            ISMax = new(num++, MultiMenu.intruder, "Max <color=#FF0000FF>Intruder</color> <color=#1D7CF2FF>Support</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                ConsigliereOn, ConsortOn, GodfatherOn, MinerOn, TeleporterOn });
            ...
            //Impostor = new(MultiMenu.intruder, "<color=#FF0000FF>Impostor</color>", ImpostorOn);
            ...
            SyndicateDisruptionSettings = new(MultiMenu.syndicate, "<color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Disruption</color> Settings", new[] { ConcealerOn, DrunkardOn,
                FramerOn, ShapeshifterOn, SilencerOn });
            SDMax = new(num++, MultiMenu.syndicate, "Max <color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Disruption</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                ConcealerOn, DrunkardOn, FramerOn, ShapeshifterOn, SilencerOn });
            ...
            SyndicateKillingSettings = new(MultiMenu.syndicate, "<color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Killing</color> Settings", new[] { BomberOn, ColliderOn, CrusaderOn,
                PoisonerOn });
            SyKMax = new(num++, MultiMenu.syndicate, "Max <color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Killing</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                BomberOn, ColliderOn, CrusaderOn, PoisonerOn });
            ...
            SPMax = new(num++, MultiMenu.syndicate, "Max <color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Power</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                SpellslingerOn, TimeKeeperOn });
            ...
            SSuMax = new(num++, MultiMenu.syndicate, "Max <color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Support</color> <color=#FFD700FF>Roles</color>", 1, 1, 14, 1, new[] {
                RebelOn, StalkerOn, WarperOn });
            ...
            AbilitySettings = new(MultiMenu.ability, "<color=#FF9900FF>Ability</color> Settings", new[] { CrewAssassinOn, NeutralAssassinOn, IntruderAssassinOn, SyndicateAssassinOn,
                ButtonBarryOn, InsiderOn, MultitaskerOn, NinjaOn, PoliticianOn, RadarOn, RuthlessOn, SnitchOn, SwapperOn, TiebreakerOn, TunnelerOn, UnderdogOn });
            MaxAbilities = new(num++, MultiMenu.ability, "Max <color=#FF9900FF>Abilities</color>", 5, 1, 14, 1, new[] { CrewAssassinOn, NeutralAssassinOn, IntruderAssassinOn,
                SyndicateAssassinOn, ButtonBarryOn, InsiderOn, MultitaskerOn, NinjaOn, PoliticianOn, RadarOn, RuthlessOn, SnitchOn, SwapperOn, TiebreakerOn, TunnelerOn, UnderdogOn });
            MinAbilities = new(num++, MultiMenu.ability, "Min <color=#FF9900FF>Abilities</color>", 5, 1, 14, 1, new[] { CrewAssassinOn, NeutralAssassinOn, IntruderAssassinOn,
                SyndicateAssassinOn, ButtonBarryOn, InsiderOn, MultitaskerOn, NinjaOn, PoliticianOn, RadarOn, RuthlessOn, SnitchOn, SwapperOn, TiebreakerOn, TunnelerOn, UnderdogOn });
            ...
            AssassinGuessModifiers = new(num++, MultiMenu.ability, "<color=#073763FF>Assassin</color> Can Guess Select <color=#7F7F7FFF>Modifiers</color>", false, new[] { CrewAssassinOn,
                NeutralAssassinOn, IntruderAssassinOn, SyndicateAssassinOn });
            AssassinGuessObjectifiers = new(num++, MultiMenu.ability, "<color=#073763FF>Assassin</color> Can Guess Select <color=#DD585BFF>Objectifiers</color>", false, new[] {
                CrewAssassinOn, NeutralAssassinOn, IntruderAssassinOn, SyndicateAssassinOn });
            ...
            ObjectifierSettings = new(MultiMenu.objectifier, "<color=#DD585BFF>Objectifier</color> Settings", new[] { AlliedOn, CorruptedOn, DefectorOn, FanaticOn, LinkedOn, LoversOn,
                RivalsOn, MafiaOn, OverlordOn, TaskmasterOn, TraitorOn });
            ...
            FanaticColourSwap = new(num++, MultiMenu.objectifier, "Turned <color=#678D36FF>Fanatic</color> Swaps Colours For Investigative <color=#FFD700FF>Roles</color>", false,
                FanaticOn);
            SnitchSeesFanatic = new(num++, MultiMenu.objectifier, "<color=#D4AF37FF>Snitch</color> Sees Turned <color=#678D36FF>Fanatic</color>", true, new[] { FanaticOn, SnitchOn },
                true);
            RevealerRevealsFanatic = new(num++, MultiMenu.objectifier, "<color=#D3D3D3FF>Revealer</color> Reveals Turned <color=#678D36FF>Fanatic</color>", false, new[] { FanaticOn,
                RevealerOn }, true);
            ...
            LoversFaction = new(num++, MultiMenu.objectifier, "<color=#FF66CCFF>Lovers</color> Can Be From The Same Faction", true, LoversOn);
            ...
            RivalsFaction = new(num++, MultiMenu.objectifier, "<color=#3D2D2CFF>Rivals</color> Can Be From The Same Faction", true, RivalsOn);
            ...
            SnitchSeesTraitor = new(num++, MultiMenu.objectifier, "<color=#D4AF37FF>Snitch</color> Sees Turned <color=#370D43FF>Traitor</color>", true, new[] { TraitorOn, SnitchOn },
                true);
            RevealerRevealsTraitor = new(num++, MultiMenu.objectifier, "<color=#D3D3D3FF>Revealer</color> Reveals Turned <color=#370D43FF>Traitor</color>", false, new[] { TraitorOn,
                RevealerOn }, true);
