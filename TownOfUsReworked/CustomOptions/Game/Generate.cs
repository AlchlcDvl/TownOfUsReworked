...
public static class Generate
{
    ...
    public static void GenerateAll()
    {
        ...
        CURoles = new(MultiMenu.Crew, "<color=#8CFFFFFF>Crew</color> <color=#1D7CF2FF>Utility</color> <color=#FFD700FF>Roles</color>", new object[] { GameMode.Classic, GameMode.AllAny,
            GameMode.Custom });
        CrewmateOn = new(MultiMenu.Crew, "<color=#8CFFFFFF>Crewmate</color>", parent: CURoles);
        ...
        WerewolfVent = new(MultiMenu.Neutral, "<color=#9F703AFF>Werewolf</color> Can Vent", false, Werewolf);
        ...
        ImpostorOn = new(MultiMenu.Intruder, "<color=#FF1919FF>Impostor</color>", parent: IURoles);
        ...
        JaniCooldownsLinked = new(MultiMenu.Intruder, "Kill And Clean Cooldowns Are Linked", false, Janitor);
        ...
        CDKillCd = new(MultiMenu.Syndicate, "Chaos Drive Holder Kill Cooldown", 25f, 10f, 45f, 2.5f, CooldownFormat);
        ...
        SURoles = new(MultiMenu.Syndicate, "<color=#008000FF>Syndicate</color> <color=#1D7CF2FF>Utility</color> <color=#FFD700FF>Roles</color>", new object[] { GameMode.Classic,
            GameMode.AllAny, GameMode.KillingOnly, GameMode.Custom });
        AnarchistOn = new(MultiMenu.Syndicate, "<color=#008000FF>Anarchist</color>", parent: SURoles);
        ...
        SpellCd = new(MultiMenu.Syndicate, "Spell Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat, Spellslinger);
        SpellCdIncrease = new(MultiMenu.Syndicate, "Spell Cooldown Increases By", 5f, 2.5f, 30f, 2.5f, CooldownFormat, Spellslinger);
        ...
        LogMessage($"There exist {CustomOption.AllOptions.Count(x => x.Type is not (CustomOptionType.Header or CustomOptionType.Button))} options lmao (number jumpscare)");
    }
}