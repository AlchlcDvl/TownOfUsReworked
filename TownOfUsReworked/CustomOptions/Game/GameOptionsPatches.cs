...
public static class SettingsPatches
{
            ...
            if (option.Setting == null)
            {
                switch (option.Type)
                {
                    ...
                    case CustomOptionType.String: //Background = 0, + = 1, - = 2, Title = 3, Val = 4
                        ...
                        str.transform.GetChild(2).localPosition += new Vector3(1, 0f, 0f);
    ...
    public static class PlayerControlPatch
    {
        public static void Postfix()
        {
            ...
            CallRpc(CustomRPC.Misc, MiscRPC.SyncSummary, ReadDiskText("Summary"));
    ...
    public static class PlayerJoinPatch
    {
        ...
        {
            if (CustomPlayer.AllPlayers.Count < 1 || !AmongUsClient.Instance || !CustomPlayer.Local || !__instance.myPlayer)
                return;

            if (__instance.myPlayer == CustomPlayer.Local && !SentOnce)
            {
