...
namespace TownOfUsReworked.PlayerLayers.Roles.IntruderRoles.BlackmailerMod
{
    ...
    public class HUDBlackmail
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            Utils.SetTarget(ref role.ClosestPlayer, role.BlackmailButton, GameOptionsData.KillDistances[GameOptionsManager.Instance.currentNormalGameOptions.KillDistance],
                notBlackmailed);
