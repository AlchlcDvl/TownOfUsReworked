...
namespace TownOfUsReworked.PlayerLayers.Roles.IntruderRoles.ConsortMod
{
    ...
    public class HUDBlock
    {
        public static void Postfix(HudManager __instance)
        {
            ...
            role.BlockButton.UpdateButton(role, "BLOCK", role.RoleblockTimer(), CustomGameOptions.ConsRoleblockCooldown, TownOfUsReworked.Placeholder, AbilityTypes.Direct, null,
