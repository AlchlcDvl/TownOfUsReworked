...
namespace TownOfUsReworked.PlayerLayers.Roles.NeutralRoles.PestilenceMod
{
    ...
    public static class Outro
    {
        public static void Postfix(EndGameManager __instance)
        {
            ...
            var role = Role.AllRoles.FirstOrDefault(x => x.RoleType == RoleEnum.Pestilence && ((Pestilence)x).PestilenceWins);
            ...
            try
            {
                AudioClip JuggernautWinSFX = TownOfUsReworked.loadAudioClipFromResources("TownOfUsReworked.Resources.GlitchWin.raw");
