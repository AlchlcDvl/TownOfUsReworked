...
public class Survivor : Neutral
{
    ...
    public override void Init()
    {
        ...
        VestButton ??= CreateButton(this, new SpriteName("Vest"), AbilityType.Targetless, KeybindType.ActionSecondary, (OnClick)HitVest, new Cooldown(VestCd), "VEST", new Duration(VestDur),
            MaxVests);
    }
