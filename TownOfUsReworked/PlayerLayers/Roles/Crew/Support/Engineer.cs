...
public sealed class Engineer : CSupport
{
    ...
    public override void Init() => FixButton ??= new(this, "FIX SABOTAGE", new SpriteName("Fix"), ReworkedAbilityTypes.Targetless, KeybindType.ActionSecondary, (OnClickTargetless)Fix, new Cooldown(FixCd),
        MaxFixes, (ConditionFunc)Condition);
