...
namespace TownOfUsReworked.PlayerLayers.Roles.CrewRoles.MediumMod
{
    ...
    public class MediateDead
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (PlayerControl.LocalPlayer.Data.IsDead && CustomGameOptions.ShowMediumToDead && Role.AllRoles.Any(x => x.RoleType == RoleEnum.Medium && ((Medium)x).MediatedPlayers.Keys.
