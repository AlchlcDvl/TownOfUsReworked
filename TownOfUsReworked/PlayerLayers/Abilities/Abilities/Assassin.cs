    ...
    public class Assassin : Ability
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (!PlayerControl.LocalPlayer.Is(Faction.Intruders))
            {
                ...
                if (CustomGameOptions.TimeMasterOn > 0) ColorMapping.Add("Time Master", Colors.TimeMaster);
            ...
            if (CustomGameOptions.MurdererOn > 0 && !PlayerControl.LocalPlayer.Is(RoleEnum.Murderer)) ColorMapping.Add("Murderer", Colors.Murderer);
            ...
            if (CustomGameOptions.DraculaOn > 0 && !(PlayerControl.LocalPlayer.Is(RoleEnum.Dracula) | PlayerControl.LocalPlayer.Is(RoleEnum.Vampire) | PlayerControl.LocalPlayer.Is(RoleEnum.Dampyr)))
            {
            ...
            if (CustomGameOptions.AssassinGuessObjectifiers)
            {
                ...
                if (CustomGameOptions.FanaticOn > 0) ColorMapping.Add("Fanatic", Colors.Lovers);
                if (CustomGameOptions.RivalsOn > 0) ColorMapping.Add("Rivals", Colors.Traitor);
            }
