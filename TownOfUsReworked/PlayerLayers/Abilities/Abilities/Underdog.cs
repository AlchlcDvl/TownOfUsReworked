namespace TownOfUsReworked.PlayerLayers.Abilities
{
    public class Underdog : Ability
    {
        ...
        public override Func<string> Description => () => Last(Player) ? "- You have shortened cooldowns" : (CustomGameOptions.UnderdogIncreasedKC ? ("- You have long cooldowns while " +
            "you're not alone") : "- You have short cooldowns when you're alone");
