    ...
    public static class ShipStatus_SetEverythingUp
    {
        public static bool Prefix(EndGameManager __instance)
        {
            ...
            var (texttext, winsound, color) = WinState switch
            {
                ...
                WinLose.JesterWins => ("Jester Wins", "JesterWin", CustomColorManager.Jester),
                ...
                WinLose.PhantomWins => ("Phantom Wins", "PhantomWin", CustomColorManager.Phantom),
                ...
                WinLose.ApocalypseWins => ("The Apocalypse Is Neigh", "ApocalypseWin", CustomColorManager.Apocalypse),
                WinLose.ArsonistWins => ("Arsonist Wins", "ArsonistWin", CustomColorManager.Arsonist),
                WinLose.CryomaniacWins => ("Cryomaniac Wins", "IntruderWin", CustomColorManager.Cryomaniac),
                WinLose.GlitchWins => ("Glitch Wins", "GlitchWin", CustomColorManager.Glitch),
                WinLose.JuggernautWins => ("Juggernaut Wins", "JuggernautWin", CustomColorManager.Juggernaut),
                ...
                WinLose.WerewolfWins => ("Werewolf Wins", "WerewolfWin", CustomColorManager.Werewolf),
