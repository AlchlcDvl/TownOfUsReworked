...
{
    // Client Settings
    [HeaderOption(MultiMenu.Client, [ "LighterDarker", "WhiteNameplates", "NoLevels", "CustomCrewColors", "CustomNeutColors", "CustomIntColors", "CustomSynColors", "CustomModColors", "CustomObjColors", "CustomAbColors", "CustomEjects", "OptimisationMode", "HideOtherGhosts" ], ClientOnly = true)]
