...
public abstract class Option(CustomOptionType type) : INetSerializable
{
    ...
    [
        ...
        (["HunterCount", "HuntCd", "StartTime", "HunterVent", "HunterVision", "HuntedVision", "HunterSpeedModifier", "HuntedChat", "HunterFlashlight", "HuntedFlashlight", "HnSMode"], [
            Mode.HideAndSeek]),
        (["RandomMapSkeld", "RandomMapMira", "RandomMapPolus", "RandomMapdlekS", "RandomMapAirship", "RandomMapFungle"], [Map.Random]),
        (["RandomMapSubmerged"], [Map.Random, "SubLoaded"]),
        (["RandomMapLevelImpostor"], [Map.Random, "LiLoaded"]),
        (["SmallMapHalfVision", "SmallMapDecreasedCooldown", "SmallMapIncreasedShortTasks", "SmallMapIncreasedLongTasks", "OxySlow"], [Map.Skeld, Map.dlekS, Map.Random, Map.LevelImpostor,
            Map.MiraHq]),
        (["LargeMapDecreasedShortTasks", "LargeMapDecreasedLongTasks", "LargeMapIncreasedCooldown"], [Map.Airship, Map.Submerged, Map.Random, Map.Fungle, Map.LevelImpostor]),
        (["BetterSkeld"], [Map.Skeld, Map.dlekS, Map.Random]),
        (["BetterMiraHq"], [Map.MiraHq, Map.Random]),
        (["BetterPolus"], [Map.Polus, Map.Random]),
        (["BetterAirship"], [Map.Airship, Map.Random]),
        (["BetterFungle"], [Map.Fungle, Map.Random]),
