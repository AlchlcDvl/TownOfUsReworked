...
public abstract class Option(CustomOptionType type)
{
    ...
    [
        ...
        (["SmallMapHalfVision", "SmallMapDecreasedCooldown", "SmallMapIncreasedShortTasks", "SmallMapIncreasedLongTasks", "OxySlow"], [Map.Skeld, Map.dlekS, Map.Random,
            Map.MiraHq, Map.LevelImpostor]),
        (["LargeMapDecreasedShortTasks", "LargeMapDecreasedLongTasks", "LargeMapIncreasedCooldown"], [Map.Airship, Map.Submerged, Map.Random, Map.Fungle,
            Map.LevelImpostor]),
