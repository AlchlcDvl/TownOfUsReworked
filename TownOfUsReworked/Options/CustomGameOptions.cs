...
public static class CustomGameOptions
{
    ...
    public static bool EnableFailCds => Generate.EnableFailCds;
    public static float FailCooldowns => Generate.FailCooldowns;
