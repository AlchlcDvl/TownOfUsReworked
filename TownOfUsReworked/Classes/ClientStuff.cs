...
public static class ClientStuff
{
    ...
    public static void OpenRoleCard()
    {
        ...
        if (ClientHandler.Instance.ToTheWiki == null)
        {
    ...
    public static void OpenWiki()
    {
        ...
        if (ClientHandler.Instance.NextButton == null)
        {
        ...
        if (ClientHandler.Instance.BackButton == null)
        {
        ...
        if (ClientHandler.Instance.YourStatus == null)
        {
        ...
        if (ClientHandler.Instance.LoreButton == null)
        {
