...
public static class GameStates
{
    ...
    public static bool SyndicateWins() => !AllPlayers.Any(x => !x.HasDied() && (x.Is(Alignment.NeutralKill) || x.Is(Faction.Intruder) || x.Is(Alignment.NeutralNeo) ||
    ...
    public static bool AllNeutralsWin() => (!AllPlayers.Any(x => !x.HasDied() && (x.NotOnTheSameSide() || x.Is(Faction.Crew) || x.Is(Faction.Syndicate) ||
        x.Is(Faction.Intruder)))) && NeutralSettings.NoSolo == NoSolo.AllNeutrals;
