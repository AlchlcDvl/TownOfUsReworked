...
public static class References
{
    ...
    public static readonly Dictionary<LayerEnum, LayerDictionaryEntry> LayerDictionary = new()
    {
        ...
        { LayerEnum.Mafioso, new(null, CustomColorManager.Mafioso, LayerEnum.Mafioso) },
        ...
        { LayerEnum.Sidekick, new(null, CustomColorManager.Sidekick, LayerEnum.Sidekick) },
        ...
        { LayerEnum.Allied, new(typeof(Allied), CustomColorManager.Allied, LayerEnum.Allied, "ζ") },
        { LayerEnum.Corrupted, new(typeof(Corrupted), CustomColorManager.Corrupted, LayerEnum.Corrupted, "δ") },
        { LayerEnum.Defector, new(typeof(Defector), CustomColorManager.Defector, LayerEnum.Defector, "ε") },
        { LayerEnum.Fanatic, new(typeof(Fanatic), CustomColorManager.Fanatic, LayerEnum.Fanatic, "♠") },
        { LayerEnum.Linked, new(typeof(Linked), CustomColorManager.Linked, LayerEnum.Linked, "Ψ") },
        { LayerEnum.Lovers, new(typeof(Lovers), CustomColorManager.Lovers, LayerEnum.Lovers, "♥") },
        { LayerEnum.Mafia, new(typeof(Mafia), CustomColorManager.Mafia, LayerEnum.Mafia, "ω") },
        { LayerEnum.Overlord, new(typeof(Overlord), CustomColorManager.Overlord, LayerEnum.Overlord, "β") },
        { LayerEnum.Rivals, new(typeof(Rivals), CustomColorManager.Rivals, LayerEnum.Rivals, "α") },
        { LayerEnum.Taskmaster, new(typeof(Taskmaster), CustomColorManager.Taskmaster, LayerEnum.Taskmaster, "µ") },
