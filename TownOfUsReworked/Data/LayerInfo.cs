namespace TownOfUsReworked.Data
{
    ...
    public static class LayerInfo
    {
        ...
        public readonly static List<OtherInfo> AllOthers = new()
        {
            new("Invalid", "Invalid", "Invalid", "Invalid"),
            ...
            new("Objectifier", "Obj", "Objectifiers provide an alternate way for you to win, and sometimes they may override the your original win condition (see Corrupted and Mafia) or " +
                "change your win condition mid-game (see Traitor and Fanatic)."),
            new("Modifier", "Mod", "Modifiers are passive afflictions, usually negative or benign in nature, that serve no purpose and are there for fun. It cam alter a player's gameplay "
                + "based on what they might have. For example, Baits and Diseased players would want to die for their modifiers to take effect."),
            new("Ability", "Ab", "Abilities give you an additional ability on top of your original abilities, to help boost your chances of winning."),
