...
public static class AllInfo
{
    ...
    [
        ...
        new(LayerEnum.Actor, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Amnesiac, Alignment.Benign, Faction.Outcast),
        new(LayerEnum.Arsonist, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Betrayer, Alignment.Proselyte, Faction.Outcast),
        new(LayerEnum.BountyHunter, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Cannibal, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Cryomaniac, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Dracula, Alignment.Neophyte, Faction.Outcast),
        new(LayerEnum.Executioner, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Glitch, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.GuardianAngel, Alignment.Benign, Faction.Outcast),
        new(LayerEnum.Guesser, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Jackal, Alignment.Neophyte, Faction.Outcast),
        new(LayerEnum.Jester, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Juggernaut, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Murderer, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Necromancer, Alignment.Neophyte, Faction.Outcast),
        new(LayerEnum.Phantom, Alignment.Proselyte, Faction.Outcast),
        new(LayerEnum.SerialKiller, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Shifter, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Survivor, Alignment.Benign, Faction.Outcast),
        new(LayerEnum.Thief, Alignment.Benign, Faction.Outcast),
        new(LayerEnum.Troll, Alignment.Evil, Faction.Outcast),
        new(LayerEnum.Werewolf, Alignment.Killing, Faction.Outcast),
        new(LayerEnum.Whisperer, Alignment.Neophyte, Faction.Outcast, true),
