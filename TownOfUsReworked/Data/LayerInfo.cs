namespace TownOfUsReworked.Data
{
    ...
    public static class LayerInfo
    {
        public static readonly List<RoleInfo> AllRoles = new()
        {
            ...
            new("Altruist", "Alt", "The Altruist is capable of reviving dead players. After a set period of time, the player will be resurrected, if the revival isn't interrupted. Once" +
                " a player is revived, all evil players will be notified of the revival and will have an arrow pointing towards the revived player. Once the Altruist uses up all of " +
                "their ability charges, they sacrifice themselves on the last use of their ability.", RoleAlignment.CrewProt, Faction.Crew, "I know what I have to do but I don't know if" +
                " I have the strength to do it.", Colors.Altruist),
            new("Chameleon", "Cham", "The Chameleon can go invisible to stalk players and see what they do when no one is around.", RoleAlignment.CrewSupport, Faction.Crew, "Are you sure "
                + "you can see me?", Colors.Chameleon),
            new("Coroner", "Cor", "The Coroner gets an alert when someone dies and briefly gets an arrow pointing in the direction of the body. They can autopsy bodies to get some info. " +
                "They can then compare that information with players to see if they killed the body or not. The Coroner also gets a body report from the player they reported. The report " +
                "will include the cause and time of death, player's faction/role, the killer's faction/role and (according to the settings) the killer's name.", RoleAlignment.CrewInvest,
                Faction.Crew, "A body? Where? I need it for...scientific purposes.", Colors.Coroner),
            new("Crewmate", "Crew", "Just a plain Crew with no abilities and only spawns if all the other roles are taken or set to spawn in Custom mode.", RoleAlignment.CrewUtil,
                Faction.Crew, "I once made a pencil using 2 erasers...they were pointless, just like me.", Colors.Crew),
            new("Engineer", "Engi", "The Engineer can fix sabotages from anywhere on the map. They can also use vents to get across the map easily.", RoleAlignment.CrewSupport,
                Faction.Crew, "How am I going to stop some big mean mother hubbard from tearing me a structurally superfluous new behind? The solution? Use a wrench. And if that don't work"
                + ", use more wrench.", Colors.Engineer),
            ...
            new("Inspector", "Insp", "The Inspector can inspect players for their roles. Upon being inspected, the target's name will be updated to give a list of what roles the target " +
                "could possibly be.", RoleAlignment.CrewInvest, Faction.Crew, "THAT'S THE GODFATHER! YOU GOTTA BELIEVE ME.", Colors.Inspector),
            ...
            new("Mystic", "Mys", "The Mystic only spawns when there is at least one Neutral (Neophyte) role present in the game. Whenever someone's subfaction is changed, the Mystic will "
                ...
                RoleAlignment.CrewAudit, Faction.Crew, "There's a hint of corruption.", Colors.Mystic),
            new("Operative", "Op", "The Operative can place bugs around the map. When players enter the range of the bug and stay within it for a certain amount of time, they trigger it. "
                ...
                " you need to find out information is good placement and amazing levels of patience.", Colors.Operative),
            new("Retributionist", "Ret", "The Retributionist can mimic dead crewamtes. During meetings, the Retributionist can select who they are going to mimic for the following round " +
                ...
                " settings for their respective roles.", RoleAlignment.CrewSupport, Faction.Crew, "Bodies...bodies...I NEED BODIES.", Colors.Retributionist),
            new("Seer", "Seer", "The Seer only spawns if there are roles capable of changing their initial roles or if there's a Traitor or Fanatic in the game. The Seer can investigate " +
                ...
                Faction.Crew, "You've got quite the history.", Colors.Seer),
            new("Sheriff", "Sher", "The Sheriff can reveal the alliance of other players. Based on settings, the Sheriff can find out whether a player is Good or Evil. The Sheriff's screen"
                ...
                + "not an Executioner, I checked Blue and they're sus.", Colors.Sheriff),
            new("Shifter", "Shift", "The Shifter can swap roles with someone, as long as they are Crew. If the shift is unsuccessful, the Shifter dies.", RoleAlignment.CrewSupport,
                Faction.Crew, "GET BACK HERE I WANT YOUR ROLE.", Colors.Shifter),
            ...
            new("Transporter", "Trans", "The Transporter can swap the locations of two players at will. Being transported plays an animation that's visible to all players and renderers the"
                ...
                + "attack each other.", RoleAlignment.CrewSupport, Faction.Crew, "You're here and you're there. Where will you go? That's for me to decide.", Colors.Transporter),
            ...
            new("Vigilante", "Vig", "The Vigilante can kill. However, if they kill someone they shouldn't, they instead die themselves.", RoleAlignment.CrewKill, Faction.Crew, "I AM THE "
                + "HAND OF JUSTICE.", Colors.Vigilante),
            new("Actor", "Act", "The Actor gets a list of roles at the start of the game. This list of roles depends on which roles are present in the game so that it's easier for the " +
                ...
                + "am totally what you think of me as.", Colors.Actor, "Get guessed as a role in their target role list"),
            ...
            new("Arsonist", "Arso", "The Arsonist can douse players in gasoline. After dousing, the Arsonist can choose to ignite all doused players which kills all doused players at once."
                + " Doused players have an orange Ξ next to their names", RoleAlignment.NeutralKill, Faction.Neutral, "I like my meat well done.", Colors.Arsonist, "Douse and ignite " +
