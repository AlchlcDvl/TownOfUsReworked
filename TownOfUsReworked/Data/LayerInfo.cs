...
public static class AllInfo
{
    ...
    [
        ...
        new(Faction.Arsonist),
        new(Faction.Cryomaniac),
        new(Faction.Glitch),
        new(Faction.Juggernaut),
        new(Faction.Murderer),
        new(Faction.SerialKiller),
        new(Faction.Werewolf),
        new(Faction.Defector),
        new(Faction.Betrayer),
        new(Faction.Shifter),
        new(Faction.Mafia),
        new(Faction.Cabal),
        new(Faction.Cult),
        new(Faction.Followers),
        new(Faction.Reanimated),
        new(Faction.Undead),
    ...
    [
        ...
        new("Watched", "★", CustomColorManager.GuardianAngel),
        new("Protected", "η", CustomColorManager.GuardianAngel),
