...
public static class CustomColorManager
{
    ...
    public static UColor Shadow(this UColor color) => new(Mathf.Clamp(color.r - 0.2f, 0f, color.r), Mathf.Clamp(color.g - 0.2f, 0f, color.g), Mathf.Clamp(color.b - 0.2f, 0f, color.b),
        color.a);
