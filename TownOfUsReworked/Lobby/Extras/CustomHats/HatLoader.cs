...
namespace TownOfUsReworked.Lobby.Extras.CustomHats
{
    ...
    {
        private const string HAT_RESOURCE_NAMESPACE = "TownOfUsReworked.Resources.Hats";
        private const string HAT_METADATA_JSON = "metadata.json";
        private const int HAT_ORDER_BASELINE = 99;

        private static ManualLogSource Log => PluginSingleton<TownOfUsReworked>.Instance.Log;
        private static Assembly Assembly => typeof(TownOfUsReworked).Assembly;
