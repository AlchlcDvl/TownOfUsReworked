...
namespace TownOfUsReworked.Lobby.CrowdedMod.Patches
{
    internal static class GenericPatches
    {
        ...
        public static class GameOptionsMenu_Start
        {
            ...
            {
                __instance.GetComponentsInChildren<NumberOption>().First(o => o.Title == StringNames.GameNumImpostors).ValidRange =
                    new FloatRange(1, (int)(CreateGameOptionsPatches.CreateOptionsPicker_Start.maxPlayers-0.5f)/2);
            }
        }
    }
}
