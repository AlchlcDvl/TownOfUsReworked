...
public static class RoleGen
{
    ...
    private static void GenClassicCustomAA()
    {
        ...
        if (CustomGameOptions.SurvivorOn > 0 && !CustomGameOptions.AvoidNeutralBenignKingmakers)
        {
        ...
        if (CustomGameOptions.GuardianAngelOn > 0 && !CustomGameOptions.AvoidNeutralBenignKingmakers)
        {
