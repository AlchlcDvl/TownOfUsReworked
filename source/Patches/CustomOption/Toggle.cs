namespace TownOfUs.CustomOption
{
    public class CustomToggleOption : CustomOption
    {
        ...
        /*protected internal CustomToggleOption(bool indent, int id, MultiMenu menu, string name, bool value = true) : base(indent, id, menu, name, CustomOptionType.Toggle, value)
        {
            Format = val => (bool) val ? "On" : "Off";
        }*/
