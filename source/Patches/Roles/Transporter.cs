...
namespace TownOfUs.Roles
{
    public class Transporter : Role
    {
        ...
        public Transporter(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.CustomCrewColors) Color = Patches.Colors.Transporter;
        ...
        public static IEnumerator TransportPlayers(byte player1, byte player2, bool die)
        {
            ...
            {
                try {
                    AudioClip TransportSFX = TownOfUs.loadAudioClipFromResources("TownOfUs.Resources.Transport.raw");
